...
//// this loop is where the comet long-poll happens
    ...
    while ( $loop_break == false) {
	    $snmp = getAllZRELinkState( $GLOBALS["fabip"],  'ZX1900FABRIC') ;
...
importMibs();
$slots = slotOccupier($GLOBALS["shmmip"]);
////print_r($slots);////////////////////////////////////////
...
switch (  $slots[0][0]  ) {	//slot1
    case '"Switch"':
        ...
        $data["slot1"]["baseip"] = $GLOBALS["baseip"] ;		//
        $data["slot1"]["fabip"] = $GLOBALS["fabip"] ;		//
        $data["slot1"]["M"] = $slots[0][1] ;	//mark M state
        $data["slot1"]["fabric ports"] = getAllZRELinkState( $GLOBALS["fabip"],  'ZX1900FABRIC') ; //load up on snmp data
        $data["slot1"]["base ports"] = getAllZRELinkState( $GLOBALS["baseip"],  'ZX1900BASE') ; //load up on snmp data
        $data["slot1"]["fabric ext"] =  getExtState( $GLOBALS["fabip"],  'ZX1900FABRIC') ; 
        $data["slot1"]["fabric int"] =  getIntState( $GLOBALS["fabip"],  'ZX1900FABRIC') ; 
        $data["slot1"]["base ext"] =  getExtState( $GLOBALS["baseip"],  'ZX1900BASE') ; 
        $data["slot1"]["base int"] =  getIntState( $GLOBALS["baseip"],  'ZX1900BASE') ; 
        break;
...
switch (  $slots[2][0]  ) {	//slot3
    case '"Payload Switch"':
        ...
        $data["slot3"]["ip"] = $GLOBALS["slot3_ip"] ;		//
        $data["slot3"]["M"] = $slots[2][1] ;	//mark M state
        $data["slot3"]["7300 ports"] = getAllZRELinkState( $GLOBALS["slot3_ip"],  'ZX7300') ; //load up on snmp data
        $data["slot3"]["7300 ext"] =  getExtState($GLOBALS["slot3_ip"],  'ZX7300') ; 
        $data["slot3"]["7300 int"] =  getIntState( $GLOBALS["slot3_ip"],  'ZX7300') ; 
        break;
    case '"MPCBL0030"':
        $data["slot3"]["name"] = "SBC" ;
        $data["slot3"]["ip"] = $GLOBALS["slot3_ip"] ;	
        $data["slot3"]["M"] = $slots[2][1] ;
        $data["slot3"][2] = getSNMPLinux( $GLOBALS["slot3_ip"],  'LINUXMIB') ;
        break;
     default:				// all other matches get marked empty!
...
switch (  $slots[3][0]  ) {	//slot4
    case '"Payload Switch"':
        ...
        $data["slot4"]["ip"] = $GLOBALS["slot4_ip"] ;
        $data["slot4"]["7300 ports"] = getAllZRELinkState( $GLOBALS["slot4_ip"],  'ZX7300') ; //load up on snmp data
        $data["slot4"]["7300 ext"] =  getExtState($GLOBALS["slot4_ip"],  'ZX7300') ; 
        $data["slot4"]["7300 int"] =  getIntState( $GLOBALS["slot4_ip"],  'ZX7300') ; 
        break;
    case '"MPCBL0030"':
        $data["slot4"]["name"] = "SBC" ;
        $data["slot4"]["ip"] = $GLOBALS["slot4_ip"] ;
        $data["slot4"]["M"] = $slots[3][1] ;
        $data["slot4"][2] = getSNMPLinux( $GLOBALS["shmmip"],  'LINUXMIB') ;
        break;
     default:
...
switch (  $slots[4][0]  ) {  //slot5
    case '"Payload Switch"':
        ...
        $data["slot5"]["ip"] = $GLOBALS["slot5_ip"] ;
        $data["slot5"]["7300 ports"] = getAllZRELinkState( $GLOBALS["slot5_ip"],  'ZX7300') ; //load up on snmp data
        $data["slot5"]["7300 ext"] =  getExtState($GLOBALS["slot5_ip"],  'ZX7300') ; 
        $data["slot5"]["7300 int"] =  getIntState( $GLOBALS["slot5_ip"],  'ZX7300') ; 
        break;
    case '"MPCBL0030"':
        $data["slot5"]["name"] = "SBC" ;
        $data["slot5"]["ip"] = $GLOBALS["slot5_ip"] ;
        $data["slot5"]["M"] = $slots[4][1] ;
        $data["slot5"][2] = getSNMPLinux( $GLOBALS["shmmip"],  'LINUXMIB') ;
        break;
     default:
...
$data["shmc"][0] = getSNMPShMC( $GLOBALS["shmmip"],  'PPS-SENTRY-MIB') ;
$data["shmc"]["ip"] =  $GLOBALS["shmmip"] ;
$data["zenoss"]["ip"] =  "localhost" ;
