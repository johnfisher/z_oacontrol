var ZnyxPortlet1Datasource = Class.create();

ZnyxPortlet1Datasource.prototype = {
    __class__ : "YAHOO.zenoss.portlet.ZnyxPortlet1Datasource",
    ...
    get: function(callback) {
        ...
        if (url == YAHOO.zenoss.portlet.DEFAULT_ZNYXPORTLET_URL) {
...
YAHOO.zenoss.portlet.ZnyxPortlet1Datasource = ZnyxPortlet1Datasource;

var ZnyxPortlet1Portlet = YAHOO.zenoss.Subclass.create(
    YAHOO.zenoss.portlet.Portlet);
ZnyxPortlet1Portlet.prototype = {
    __class__: "YAHOO.zenoss.portlet.ZnyxPortlet1Portlet",
    __init__: function(args) {
        args = args || {};
        id = 'id' in args? args.id : getUID('znyxportlet1');
        baseLoc = 'baseLoc' in args? args.baseLoc : YAHOO.zenoss.portlet.DEFAULT_ZNYXPORTLET_URL;
        bodyHeight = 'bodyHeight' in args? args.bodyHeight : 500;
        title = 'title' in args? args.title: "ZX1900";
        ...
        var datasource = 'datasource' in args? 
            args.datasource:
            new YAHOO.zenoss.portlet.ZnyxPortlet1Datasource(
    ...
    buildSettingsPane: function() {
        ...
        */
        ...
        var container = DIV({
            ...
            DIV({'class':'control-label'}, 'URL (http://john/jquery_svg/jquery_svg_blinky4.html)'),
            this.locsearch
           ]
        );
...
YAHOO.zenoss.portlet.ZnyxPortlet1Portlet = ZnyxPortlet1Portlet;
