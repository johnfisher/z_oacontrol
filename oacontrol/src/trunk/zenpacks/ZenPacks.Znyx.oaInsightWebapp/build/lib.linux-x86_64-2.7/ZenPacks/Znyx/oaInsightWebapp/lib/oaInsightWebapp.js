var oaInsightWebappDatasource = Class.create();


oaInsightWebappDatasource.prototype = {
    __class__ : "YAHOO.zenoss.portlet.oaInsightWebappDatasource",
    ...
    get: function(callback) {
        ...
        //}
		var url = '/++resource++oaInsightWebapp/oai.html'; // this '/++resource++oaInsightWebappPortlet/oai.html' is the "resources" dir in the zenpack 
...
YAHOO.zenoss.portlet.oaInsightWebappDatasource = oaInsightWebappDatasource;

var oaInsightWebapp = YAHOO.zenoss.Subclass.create(
    YAHOO.zenoss.portlet.Portlet);
oaInsightWebapp.prototype = {
    __class__: "YAHOO.zenoss.portlet.oaInsightWebapp",
    __init__: function(args) {
        args = args || {};
        id = 'id' in args? args.id : getUID('oaInsight');
        ...
        title = 'title' in args? args.title: "oaInsight Webapp";
        ...
        var datasource = 'datasource' in args? 
            args.datasource:
            new YAHOO.zenoss.portlet.oaInsightWebappDatasource(
...
YAHOO.zenoss.portlet.oaInsightWebapp = oaInsightWebapp;
