...
OAC3Datasource.prototype = {
    ...
    get: function(callback) {
		...
		//var url ;//= this.baseLoc; // baseLoc is the zenoss coporate site
        //if (url == YAHOO.zenoss.portlet.DEFAULT_SITEWINDOW_URL) {
           // url += '?v=' + YAHOO.zenoss.ZENOSS_VERSION + '&p=' + YAHOO.zenoss.ZENOSS_PRODUCT;
        //}
		var url = '/++resource++OAC3Portlet/demo.html' + ; // this '/++resource++OAC3Portlet/test.html' is the "resources" dir in the zenpack 
