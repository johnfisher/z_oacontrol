...
// vars for identifying boards; one day self-generating
var basehost = '10.2.0.155';
var fabrichost = '10.2.0.215';
var zenosshost = '10.2.0.233' ;
		...
		if ( id.match("ledApopbz") ) {  // one of the 1900A base popup leds
		 //logDebug(" id ledApopbz " + id + "<br>");
			// http://10.2.0.233:8080/zport/dmd/Devices/Network/OASwitch/ZX1900BaseDevice/devices/10.2.0.155/devicedetail#deviceDetailNav:IpInterface:/zport/dmd/Devices/Network/OASwitch/ZX1900BaseDevice/devices/10.2.0.155/os/interfaces/zre1
				...
				var zreurl = 'http://' + zenosshost + ':8080/zport/dmd/Devices/Network/OASwitch/ZX1900BaseDevice/devices/' + basehost + '/devicedetail#deviceDetailNav:IpInterface:/zport/dmd/Devices/Network/OASwitch/ZX1900BaseDevice/devices/' + basehost + '/os/interfaces/zre' + zrenum
				...
				var zrenum = id.substr(9);
				var zreurl = 'http://' + zenosshost + ':8080/zport/dmd/Devices/Network/OASwitch/ZX1900FabricDevice/devices/' + fabrichost + '/devicedetail#deviceDetailNav:IpInterface:/zport/dmd/Devices/Network/OASwitch/ZX1900FabricDevice/devices/' + fabrichost + '/os/interfaces/zre' + zrenum
				$('#' + id ).mouseenter(function(){
					//logDebug("mouseover stroke id= " + id + "<br>");
					 $('#' + id ).css("stroke", ltblue);
				});
